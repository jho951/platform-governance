 ...
 * Registering a custom bean is rejected by auto-configuration. Replace
 * {@link GovernanceDecisionEngine} or add {@link GovernancePolicyPlugin} beans
 * for service-specific decisions so the platform wrapper can keep audit
