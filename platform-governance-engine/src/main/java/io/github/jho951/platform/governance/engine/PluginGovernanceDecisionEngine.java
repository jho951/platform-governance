...
public final class PluginGovernanceDecisionEngine implements GovernanceDecisionEngine {
    private final List<GovernancePolicyPlugin> plugins;
    private final boolean strict;
    private final GovernanceEngineFailurePolicy failurePolicy;

    public PluginGovernanceDecisionEngine(List<GovernancePolicyPlugin> plugins, boolean strict) {
        this(plugins, strict, GovernanceEngineFailurePolicy.FAIL_CLOSED);
    }

    public PluginGovernanceDecisionEngine(
